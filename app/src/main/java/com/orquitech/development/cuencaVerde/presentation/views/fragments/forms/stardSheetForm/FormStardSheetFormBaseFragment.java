...
public abstract class FormStardSheetFormBaseFragment extends BaseFragment implements FormStardSheetFormViewMvvm.View {
    ...
    protected FormStardSheetFormViewMvvm.ViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewModel = (FormStardSheetFormViewMvvm.ViewModel) viewModelFactory.getViewModel(this, AppViewModelsFactory.FORM_STARD_SHEET_FORM_VIEW_VIEW_MODEL);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelable(STARD_SHEET_FORM, viewModel.getStardSheetForm());
    ...
    @Override
    public void setHydrologicalSourceCloseToTheHousehold(boolean isChecked) {
        if (binding instanceof FragmentFormStardSheetFormPart1Binding) {
            ((FragmentFormStardSheetFormPart1Binding) binding).thereHydrologicalSourceCloseHouseholdFields.setVisibility(isChecked ? View.GONE : View.VISIBLE);
            ((FragmentFormStardSheetFormPart1Binding) binding).sourceFields.setVisibility(isChecked ? View.VISIBLE : View.GONE);
        }
    }

    @Override
    public StardSheetForm getStardSheetForm() {
        return viewModel.getStardSheetForm();
    }
