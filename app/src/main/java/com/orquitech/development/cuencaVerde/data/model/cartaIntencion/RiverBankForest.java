...
public class RiverBankForest implements Parcelable {
    ...
    protected RiverBankForest(Parcel in) {
    ...
    public static final Creator<RiverBankForest> CREATOR = new Creator<RiverBankForest>() {
        @Override
        public RiverBankForest createFromParcel(Parcel source) {
            return new RiverBankForest(source);
        }

        @Override
        public RiverBankForest[] newArray(int size) {
            return new RiverBankForest[size];
        }
    };
}
