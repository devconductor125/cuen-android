...
public class OriginsForest implements Parcelable {
    ...
    protected OriginsForest(Parcel in) {
    ...
    public static final Creator<OriginsForest> CREATOR = new Creator<OriginsForest>() {
        @Override
        public OriginsForest createFromParcel(Parcel source) {
            return new OriginsForest(source);
        }

        @Override
        public OriginsForest[] newArray(int size) {
            return new OriginsForest[size];
        }
    };
}
