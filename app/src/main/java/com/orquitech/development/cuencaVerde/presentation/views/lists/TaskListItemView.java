...
import com.orquitech.development.cuencaVerde.databinding.TaskItemBinding;
...
public class TaskListItemView extends BaseListView implements ItemView, TaskItemViewMvvm.View {
    ...
    protected void init(Context context) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.task_item, this, true);
    }
