...
import com.orquitech.development.cuencaVerde.databinding.FragmentErosiveProcessListBinding;
...
import com.orquitech.development.cuencaVerde.presentation.views.viewModel.ErosiveProcessDetailViewMvvm;
...
public class ErosiveProcessListFragment extends BaseFragment implements ErosiveProcessDetailViewMvvm.View, ItemList {

    private FragmentErosiveProcessListBinding binding;
    private ErosiveProcessDetailViewMvvm.ViewModel viewModel;
    ...
    public static ErosiveProcessListFragment getInstance(Bundle data) {
        ErosiveProcessListFragment fragment = new ErosiveProcessListFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_erosive_process_list, container, false);
        viewModel = (ErosiveProcessDetailViewMvvm.ViewModel) viewModelFactory.getViewModel(this, AppViewModelsFactory.EROSIVE_PROCESS_LIST_VIEW_MODEL);
    ...
    public void refreshSiembraDetails() {
        binding.swipeRefresh.setRefreshing(true);
        fadeOutList();
        viewModel.getErosiveProcessForms(true);
    }
    ...
    public void onItemClicked(Item item) {
        if (!binding.swipeRefresh.isRefreshing()) {
            ...
            if (item instanceof ErosiveProcessForm) {
                bundle.putParcelable(RxBus.PAYLOAD, (ErosiveProcessForm) item);
                openErosiveProcessForm(bundle);
            }
        }
    }
    ...
    @Override
    public void openErosiveProcessForm(Bundle bundle) {
        bundle.putParcelable(RxBus.TASK, task);
        activity.changeToActivity(AppViewsFactory.EROSIVE_PROCESS_FORM_VIEW, bundle);
    }
}
