...
import com.orquitech.development.cuencaVerde.databinding.FragmentFormStardMonitorAndMaintenancePart2Binding;
...
public class FormStardMonitorAndMaintenanceFragmentPart2 extends FormStardMonitorAndMaintenanceBaseFragment {

    public static FormStardMonitorAndMaintenanceFragmentPart2 getInstance(Bundle data) {
        FormStardMonitorAndMaintenanceFragmentPart2 fragment = new FormStardMonitorAndMaintenanceFragmentPart2();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_form_stard_monitor_and_maintenance_part2, container, false);
        super.onCreateView(inflater, container, savedInstanceState);
        ((FragmentFormStardMonitorAndMaintenancePart2Binding) binding).mainToolbar.setListener(new ToolBarListenerAdapter() {
            @Override
    ...
    protected void setViewModel() {
        ((FragmentFormStardMonitorAndMaintenancePart2Binding) binding).setViewModel(viewModel);
    }
