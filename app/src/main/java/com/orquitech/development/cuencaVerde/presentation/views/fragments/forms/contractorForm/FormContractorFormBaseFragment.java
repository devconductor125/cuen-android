...
public abstract class FormContractorFormBaseFragment extends BaseFragment implements FormContractorFormViewMvvm.View {
    ...
    protected FormContractorFormViewMvvm.ViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewModel = (FormContractorFormViewMvvm.ViewModel) viewModelFactory.getViewModel(this, AppViewModelsFactory.FORM_CONTRACTOR_FORM_VIEW_VIEW_MODEL);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelable(STARD_SHEET_FORM, viewModel.getContractorForm());
    ...
    public ContractorForm getContractorForm() {
        return viewModel.getContractorForm();
    }
