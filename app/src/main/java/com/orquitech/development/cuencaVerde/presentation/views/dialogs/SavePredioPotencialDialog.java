...
public class SavePredioPotencialDialog extends CustomDialog {

    public SavePredioPotencialDialog(Context context, DialogListener dialog) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setDialogTitle(R.string.save_predio_potencial_question);
    }
