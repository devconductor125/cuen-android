...
public class TasksActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            BaseFragment fragment = viewsFactory.getAppFragmentView(AppViewsFactory.TASKS_VIEW, bundle);
            ...
            case AppViewsFactory.SURVEY_VIEW:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        showMessage(TextUtil.getString(this, R.string.send_survey_success), R.color.colorSecondary);
                        break;
                }
                break;
            case AppViewsFactory.MAP_TASK_VIEW:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        showMessage(TextUtil.getString(this, R.string.send_map_success), R.color.colorSecondary);
                        break;
                }
                break;
        }
